...
var theme = document.querySelector('#thecsssheet');

function linkStyleSheet(){
    widthOfScreen=window.innerWidth;
    console.log({ widthOfScreen })

            if(widthOfScreen>=800 && theme.getAttribute('href').endsWith('/dylan7smallcss.css')){
                console.log({ theme })
                theme.setAttribute("href", "../resources/dylan7css.css")
            ...
            else if(widthOfScreen<800 && theme.getAttribute('href').endsWith('/dylan7css.css')){
                theme.setAttribute("href", "../resources/dylan7smallcss.css")
            }

}
window.addEventListener('load', linkStyleSheet)
window.addEventListener('resize', linkStyleSheet);
...
//connecting the actions of making divs visible and changing the backgrounds with their selected buttons
  document.querySelector('#gallerybutton').addEventListener("click", 
    ...
    document.querySelector('#locationbutton').addEventListener("click", function(){
            ...
            makeSelectedMajorDivVisible('upcominglocationdiv', '.majordivheaders');
            ...
            //  if(document.querySelector('#presentlocationdiv')){
              //  document.querySelector('#presentlocationdiv').style.marginLeft='5vw';
               ...
               // document.querySelector('h3').style.color=activeAccentColor;
                ...
                //makeAccessible()}
              if(document.querySelector('#upcominglocationdiv')){
          ...
          //For all but main page buttons... 
           if(event.target.id === "gallerybutton" 
            ...
            //if the 'about me button was clicked...'                
                    ...
                    || currentSelectedNavButton===document.querySelector("#aboutmebutton")){
      ...
      //creating titles for paras
        if(widthOfScreen<800){
            if(aLetter==='p'){
              ...
              var relevantPic = document.querySelector(`#p${aNum}`);
             // console.log(relevantPic + "s relevant pic")
              relevantPic.insertAdjacentElement("beforebegin", pTitle);
              pTitle.classList.add('displaynone');
            }
         else if(aLetter==='g'){
          var gTitle = document.createElement("h3");
          var titleName = arrayOfGraphicsTitleParas[aNum];
          gTitle.innerText=titleName;
          gTitle.setAttribute('id',`${aLetter}${aNum}graphicstitle`);
          pPic.classList.add('gTitle');
         
          //document.querySelector(idSignAndDivToAppend).appendChild(pTitle);
          var relevantPic = document.querySelector(`#g${aNum}`);
          //console.log(relevantPic + "s relevant pic")
          relevantPic.insertAdjacentElement("beforebegin", gTitle);
          gTitle.classList.add('displaynone');
            }
...
document.querySelector(`#p${i}`).addEventListener('click',function(){
  ...
  activePicture=document.querySelector(`#p${i}`);
    if(activePictureTitle){
      ...
      if(activePictureTitle){
      if(activePictureTitle.classList.contains('displaynone')){activePictureTitle.classList.remove('displaynone');}}
...
if(widthOfScreen<800){
 ...
 document.querySelector('body').style.contain="paint";
  document.querySelector('#postsummary').style.display='none';
 ...
 // document.querySelectorAll('.popup').forEach(function(e){e.style.maxWidth=`${.8* widthOfScreen}px`});
  ...
  document.querySelector('#contactbutton').addEventListener('click', function(){
    document.querySelector('#photodiv').style.backgroundImage='url("../resources/contact1small.png")';
  })
 ...
 // document.querySelector("#presentlocationdiv").style.justifyContent="left";
  document.querySelector("#upcominglocationdiv").innerHTML="Please contact Dylan directly, at 541-231-6068 for inquiries about these pieces."
  document.querySelector("#upcominglocationdiv").style.color='var(--color-4)';
  document.querySelector("#upcominglocationdiv").style.justifyContent="left";
  document.querySelectorAll('.navbuttons').forEach(function(e){
    e.marginLeft='0px';
    e.marginRight='0px';
    e.padding='0px';
...
window.addEventListener('load', ifSmallScreen);
window.addEventListener('resize', ifSmallScreen);

//document.querySelector('#locationbutton').addEventListener('click', function(){
  //document.querySelector("#presentlocationdiv").innerHTML="Please call or text Dylan directly at 555-555-5555 to set up a tour of his studio."
//})
...
document.querySelector('#left-span').addEventListener('click', function(){
  if(widthOfScreen>800){
    makeSelectedMajorDivVisible('invisibledivheader', '.majordivheaders');
    makeSelectedMajorDivVisible('aboutmediv', '.majordiv');
   createPhotoDiv("../resources/homepage1.png", 'right');
  createPhotoDiv2("../resources/homepage2.png", 'right');
   ...
   currentSelectedNavButton.style.backgroundImage='none';
   currentSelectedNavButton=document.querySelector("#aboutmebutton");
   currentSelectedNavButton.style.color='var(--color-2)';
   currentSelectedNavButton.style.backgroundImage='url("../resources/swirl.png")'
    adjustheader();
  }
})
