...
function logResize(){
  (console.log('window-resized from within logResize function'));
}
...
if(widthOfScreen<800){
 ...
 // document.querySelector("#presentlocationdiv").style.justifyContent="left";
  document.querySelector("#upcominglocationdiv").innerHTML="Please contact Dylan directly, at 555-555-5555 for inquiries about these pieces."
